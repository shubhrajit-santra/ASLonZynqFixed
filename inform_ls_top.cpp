...
typedef ap_ufixed<24,14> fix ;
typedef ap_ufixed<11,1> fix1 ;
...
#pragma HLS INTERFACE axis register both port=inform11
	...
	ap_uint<3> arms, vacant, occupied ;
	ap_uint<1> b1, b2, b3, b4, flag ;
	fix1 r, P1, P2, P3, P4 ;
	static fix X1, X2, X3, X4 ;
	static ap_uint<14> T1, T2, T3, T4 ;
	...
	else
	{
		...
		r = fix1((float)out_rand/UINT_MAX) ;
